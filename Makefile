...
sync-dist: build
	@gsutil cp build/dist/prebid.js gs://ads-gci-www-gannett-cdn-com/vendor/pbjsandwich-v1.min.js
	@curl -s -X PURGE "https://${FASTLY_PURGE_USER_CDN}:${FASTLY_PURGE_PASS_CDN}@www.gannett-cdn.com/partner/vendor/pbjsandwich-v1.min.js" > /dev/null

sync-dev: build-dev
	@gsutil cp build/dev/prebid.js gs://ads-gci-www-gannett-cdn-com/vendor/pbjsandwich-v1.js
	@curl -s -X PURGE "https://${FASTLY_PURGE_USER_CDN}:${FASTLY_PURGE_PASS_CDN}@www.gannett-cdn.com/partner/vendor/pbjsandwich-v1.js" > /dev/null
